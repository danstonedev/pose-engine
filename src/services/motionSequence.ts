...
export function resolveComposedMotion(
  ...
  // absolute translates every later step (heading rebase, root resolution,
  // carry-forward) consumes. Runs FIRST so all direction transforms see one
  // convention; malformed sugar is left in place for the shape refusal below.

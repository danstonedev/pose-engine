 ...
 *   2. Stage playback (ExamStage3D.stepTween) and the offline sampler
 *      (motionRecording.sampleComposedMotion) both call {@link stagedBlendWithBaseline},
 *      so a headless recording remains frame-for-frame what the stage shows.
 *
